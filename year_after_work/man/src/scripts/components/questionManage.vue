...
export default {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(code == 200){
                            ...
                            utils.refreshToken(that, localStorage.getItem('R-TOKEN'), function(){that.getQuestionFn(exam, option, answer, level, classifi, status, intro)});
                        }  else {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(code == 200){
                        ...
                        that.upTips2 = '';
                        that.upTips1 = 'The exercise test is full.';
                        setTimeout(function() {
                            that.upTips1 = '';
                            $('#joinModel').modal('hide');
                        }, 1500);
    ...
    mounted() {
        this.$store.dispatch('tabChanger', 71);
