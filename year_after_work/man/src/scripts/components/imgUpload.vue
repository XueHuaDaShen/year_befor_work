    ...
    <div class="AM-top"  style="margin-top: 10px;">
        ...
        <div>
            <div style="width:50%;margin:0 auto;position:relative;">
                <!-- <div class="videoloading1" v-show="upshow">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel" style="text-align: center">上传图片</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" role="form" encType="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">选择图片 (*)</label>
                            <div class="col-sm-10" id="fileImgParent">
                                <input type="file" style="width: 60%;height: 32px;padding-top: 6px;float: left" id="fileImg" class="myfile" ref="img1" >
                                <!-- <input class="btn btn-default" type="button" value="上传" style="float:left;height: 32px;margin: 0 30px;" @click="upImg1('upload1', 1)"/>
                                <input class="btn btn-default" type="button" value="取消" style="float:left;height: 32px;margin: 0 30px;" @click="upImg1('upload1', 1)"/> -->
                        ...
                        <div class="form-group" v-show="fileImgUrl">
                            <img :src="fileImgUrl" alt="" style="max-width:100%;max-height:300px;">
                        </div>
                        <div class="form-group" v-show="fileImgUrl">
                            <label class="col-sm-2 control-label">图片路径 (*)</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" :value="fileImgUrl">
                            </div>
                        </div>
                        <div class="addTips">
                            {{addATips1}}
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" @click="startUpload">上传</button>
...
export default {
                    ...
                    that.imgFileUploadFn = Qiniu.uploader({
                        ...
                        init: {
                            ...
                            'FileUploaded': function(up, file, info) {
                                ...
                                that.fileImgUrl = that.qiniuDomain + JSON.parse(info.response).key;
                                that.imgChecked = false;
                                that.imgFail = false;
                                that.imgCheck = false;
                                that.imgUpLoad = false;
    ...
    mounted() {
        this.$store.dispatch('tabChanger', 50);
