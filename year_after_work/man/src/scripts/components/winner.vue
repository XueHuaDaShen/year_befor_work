    ...
    <div class="">
        <div class="AM-top" style="margin-top: 10px;">
            ...
            <div class="AM-topInfo per" style="-webkit-box-pack: end;padding-right:9%">
                <select class="form-control record-info" name="" id="exampleInputEmail1" v-model.trim="searchActivity">
    ...
    export default {
        ...
        methods: {
            weinnerList(page, size) {
                const that = this;
                $.ajax({
                    url: that.$store.state.rootUrl3 + '/million/award/list',
                    headers: {
                    ...
                    data: {
                        "page": page,
                        "size": size,
                        "million": that.searchActivity,
                        "pid": that.searchpid,
                        "isRobot": that.searchType
                    },
        ...
        mounted() {
            this.$store.dispatch('tabChanger', 72);
