                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li v-if="agent.status!=2 && agent.status!=4"><a href="javascript: void(0)" data-toggle='modal' data-target="#updateModal" @click="examFn(agent._id)">Audit</a></li>
...
export default {
    ...
    mounted() {
        this.$store.dispatch('tabChanger', 70);
